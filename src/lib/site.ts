...
export const siteConfig = {
  ...
  descriptionKo:
    "과거 당첨 데이터 기반 로또 추천, 최신 회차 조회, 통계 분석을 한 번에 제공하는 무료 로또 웹 서비스입니다.",
  descriptionEn:
    "Free Lotto web service with historical-data-based number recommendations, latest draw lookup, and statistics analysis."
};
