...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return createPageMetadata({
    ...
    descriptionKo:
      "이번 회차 공개 생성 수, 전략별 성과, 최근 생성 번호를 한곳에서 볼 수 있는 생성 통계 페이지입니다.",
    descriptionEn:
...
const content = {
  ko: {
    eyebrow: "생성 통계",
    title: "이번 회차에 사람들이 어떤 방식으로\n번호를 만들고 있는지 정리했습니다",
    description:
      "이 페이지는 커뮤니티 게시판이 아니라 공개 생성 현황 페이지입니다. 이번 회차 생성 수, 전략 점유율, 최근 생성 번호, 최근 평가 회차 기준 전략 성과를 간결하게 보여줍니다.",
    links: [
  ...
  en: {
    ...
    title: "A compact view of how visitors\nare creating sets for the current round",
    description:
      "This is not a discussion board. It is a public overview of current-round generation volume, strategy share, recent sets, and strategy performance against the latest evaluated draw.",
    links: [
